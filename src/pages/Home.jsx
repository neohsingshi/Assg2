...
function Home() {
    const hotels = [
        {
            image: '/Assg2/src/assets/hompton-by-the-beach.jpg',
        ...
        {
            image: '/Assg2/src/assets/bertam-resort-water-park.jpg',
        ...
        {
            image: '/Assg2/src/assets/angsana-teluk-bahang.jpg',
        ...
        {
            image: '/Assg2/src/assets/bayview-beach-resort.jpg',
            ...
            <section>
                ...
                <div className="scenic-container">
                    <div className="scenic-card">
                        <img src="/Assg2/src/assets/penanghill.jpeg" alt="景点1" />
                        <h3>Penang Hill</h3>
                    ...
                    <div className="scenic-card">
                        <img src="/Assg2/src/assets/kekloksi.jpeg" alt="景点2" />
                        <h3>Kek Lok Si</h3>
                        <p>
                    ...
                    <div className="scenic-card">
                        <img src="/Assg2/src/assets/street art.jpg" alt="景点3" />
